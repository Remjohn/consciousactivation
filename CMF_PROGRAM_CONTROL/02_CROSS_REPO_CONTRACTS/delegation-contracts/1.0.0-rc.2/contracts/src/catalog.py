...
CATALOG: tuple[ContractDefinition, ...] = (
    ...
    contract(
        ...
        ["demand_recorded"],
        {
            ...
            "activative_intent": obj(
                {
                    "function": string(minLength=1, maxLength=256),
                    "expected_effect": string(minLength=1, maxLength=512),
                    "sequence_position": integer(minimum=0),
                }
            ),
            "wrongness_locks": array(string(minLength=1, maxLength=512), minItems=1, uniqueItems=True),
            "composition": obj(
                {
        ...
        },
        {
            ...
            "activative_intent": {
                ...
                "expected_effect": "Direct attention toward the reserved title region.",
                "sequence_position": 0,
            },
            "wrongness_locks": ["Do not place the subject inside the title-safe region."],
            "composition": {
    ...
    contract(
        ...
        },
        {
            ...
            "message_versions": [{"message_type": "visual-asset-demand", "version": PROTOCOL_VERSION}],
            "features": ["authority.registry", "lifecycle.transitions", "format02.fixtures"],
