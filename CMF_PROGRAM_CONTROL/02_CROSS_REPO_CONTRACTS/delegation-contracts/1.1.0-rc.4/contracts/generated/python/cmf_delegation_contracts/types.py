...
DerivationType = Literal['DETERMINISTIC_CROP', 'DETERMINISTIC_RESIZE', 'DETERMINISTIC_FORMAT_CONVERSION', 'DETERMINISTIC_COMPOSITE', 'SEMANTIC_TRANSFORMATION', 'TRANSFORMATIVE_RECOMPOSITION']
DerivativeSemantics = Literal['NON_SEMANTIC', 'SEMANTIC_TRANSFORMATIVE']
...
class DerivativeLockInheritance(TypedDict):
    inheritance_id: str
    authoritative_parent_ref: dict[str, Any]
    parent_contract_version: str
    governing_authoritative_demand_ref: dict[str, Any]
    parent_lock_evidence: ParentLockEvidence
    derivative_ref: dict[str, Any]
    derivative_wrong_reading_locks: list[WrongReadingLockEvidence]
    derivation_type: DerivationType
    derivative_semantics: DerivativeSemantics
    authoritative_lock_authorization: AuthoritativeLockAuthorization | None
    declared_at: str
...
class CompatibilityManifest(TypedDict):
    ...
    derivative_asset_flows: dict[str, Any]
...
__all__ = ['SourceKind', 'DerivationType', 'DerivativeSemantics', 'SourceProvenance', 'WrongReadingLockEvidence', 'ParentLockEvidence', 'AuthoritativeLockAuthorization', 'DelegationEnvelope', 'VisualAssetDemand', 'VisualAssetSubmission', 'SubmissionValidationReceipt', 'AdmissionReceipt', 'VisualAssetEvent', 'DelegationSet', 'BudgetAuthorization', 'BudgetEscalationRequest', 'BudgetEscalationResponse', 'CancellationRequest', 'CancellationReceipt', 'ConstraintConflict', 'AmendmentProposal', 'AmendmentResponse', 'DemandSupersession', 'SelectiveInvalidationReceipt', 'AssetResultContract', 'ResultAcknowledgement', 'InvalidationNotice', 'RevocationNotice', 'ReplacementNotice', 'DelegationFailure', 'DelegationAuditReceipt', 'DerivativeLockInheritance', 'CompatibilityManifest', 'ContractMigration']
