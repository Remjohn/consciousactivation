...
class FixtureTests(unittest.TestCase):
    ...
    def test_constitutional_compatibility_fixtures_are_manifested_inputs(self) -> None:
        ...
        expected_files = {
            ...
            "pre-source-kind.source.json",
            "source-kind-classification-required.expected.json",
            "source-kind-owner-classification.json",
            "source-kind-migration.expected.json",
            "source-provenance-parse-only.invalid.json",
        }
