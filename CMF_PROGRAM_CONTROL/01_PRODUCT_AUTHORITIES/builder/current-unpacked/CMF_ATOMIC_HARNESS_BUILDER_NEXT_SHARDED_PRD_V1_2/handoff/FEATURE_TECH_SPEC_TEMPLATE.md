...
Provide exact schemas, versions, producer/consumer roles, examples, compatibility, authority, provenance, and invalidation.
...
- visual, temporal, golden, adversarial, and protected benchmarks;
