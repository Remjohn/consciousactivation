...
**Entry state:** The atomic harness belongs to one of the four canonical categories.
...
- **Canonical Format Category** — One of four governed production substrates: Short-Form Edited Video, 2D Character Animation, Carousels, or Supervisuals.
...
### FR-137 — Define a Shared Activative Core

**Requirement:** The Builder must provide a category-independent Activative contract covering source premise, Coach Identity DNA, Context Premise, resonance, Matrix of Edging, hidden pressure, activation direction, viewer role, stance, stakes, identity urge, participation design, intended reaction, evidence provenance, and wrong-reading locks.

**Consequences (testable):**

- The shared core supplies meaning without owning final visual or temporal form.
- Category or harness layers cannot silently rewrite ratified Activative fields.
...
### FR-145 — Use category-specific visual parsing

**Requirement:** The Visual Syntactic Parsing capability must load category and format ontologies appropriate to the production substrate.

**Consequences (testable):**

- Carousels parse slide roles and cross-slide persistence; Supervisuals parse one-frame hierarchy; video parses time states; 2D animation parses character performance and scene relationships; conversational harnesses parse Activative Calls, turn relationships, timecoded reactions, Expression Functions, landing states, and micro-commitments.
- The canonical parser procedure remains reusable while category output fields remain distinct.

**Traceability:** Decisions D007, D030, D031; journeys UJ-02, UJ-06.

### FR-146 — Use category-specific temporal and sequence parsing

**Requirement:** Sequence-bearing categories must derive observed and hypothesized sequence structure using category-native state, beat, turn, transition, continuity, pacing, silence, and sonic relationships.

**Consequences (testable):**

- Carousels represent swipe sequence without pretending to have frame-time motion.
- Supervisuals may omit temporal syntax while still declaring one-frame attention order; conversational profiles represent question → reaction → follow-up → elevation/close without pretending the guest landing is pre-scripted.

**Traceability:** Decisions D030, D031; journeys UJ-02, UJ-06.

### FR-147 — Compile Activative Sequencing Intelligence
...
- Sequence decisions cite both Activative contracts and format syntax.
- Sequencing is independently evaluated and repairable rather than hidden inside final composition.
...
**Requirement:** The Builder may claim general production readiness only after successful transfer across materially different atomic harnesses, all four category constitutions, the Visual Asset Editor, and the Delegation Contract according to their target gates.
...
- Release 1 claims all four categories are production-certified.
...
Human-reaction surfaces whose source content is elicited rather than generated. The category owns Activative Call sequences, answer/reply ingestion, timecoded Reaction Receipts, adaptive follow-ups, expression-state progression, micro-commitments, message elevation, close logic, Expression Moment extraction, and Identity DNA amendment proposals.
...
The category must preserve guest/prospect truth sovereignty. Pre-session archetype and format routes are hypotheses; final interview-derived Content Type Contracts require transcript and Expression Moment evidence.
...
- visual, temporal, conversational-turn, and expression-syntax parsing ontologies;
- composition-variable taxonomy;
- sequence and viewer/participant-state model;
...
## Dual-order constitutional rule

Visual Syntax First governs evidence discovery when reverse-engineering visual specimens. Runtime generation and interview execution remain Activation First: Activative Intelligence precedes Visual Semantics, Visual Narrative, Activative Calls, composition, and production.
...
| SM-08 | Downstream harness effectiveness | The implemented reference harness meets or exceeds its baseline on accuracy, Activative fidelity, wrong-reading rate, first-pass acceptance, latency, and cost per accepted output. |
...
| SM-10 | Run observability completeness | 100% of mandatory lifecycle, decision, repair, benchmark, waiver, and authorization transitions produce valid events and receipts. |
...
## AG-004 — Flatten the four format categories

Short-Form Edited Video, 2D Character Animation, Carousels, and Supervisuals retain separate constitutions and runtime laws.
...
- the remaining three category constitutions and their format/profile schemas;
...
3. **Release 3 — Visual Asset Editor:** production-grade editor profile, demand contracts, provenance, semantic non-mutation, evaluation, and authorization.
4. **Release 4 — Delegation Contract:** production-grade content↔editor ABI compilation and certification.
...
- **A-002:** The four category names approved in the Grill-me session are canonical for this PRD version.
