...
The active package version is `1.1.0-rc.4`. The envelope protocol remains
...
Portable derivative-lock claims pin the authoritative parent, parent contract
version, immutable parent lock evidence, derivative lock set, derivation type,
semantic classification, and any upstream authorization for relaxation.
