# M28 — Research Source Ingestion + Identity
...
Build governed source acquisition into immutable, versioned research source records with stable identity, hashes, provenance, rights/metadata and re-ingestion semantics.

## 2. Mandatory reading before action
Baseline: `00_CONTROL/01_BASELINE_AUTHORITY_READ_SET.md`
Mandate-specific:
research specs/design; existing source/provenance schemas/services; M25–27 runtime; Phase3 retrieval controls.
...
## 5. Allowed work
Implement source identity/dedup/version logic and source receipts. Do not canonicalize content in the ingestion step.
...
## 8. Acceptance
At least one real source and one re-ingestion/version case are correctly represented with stable identity, provenance and no accidental duplicate canonical source.
