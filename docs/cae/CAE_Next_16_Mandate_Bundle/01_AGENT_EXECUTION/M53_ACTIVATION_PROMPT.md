# Gemini Activation Prompt — M53

You are executing CAE Mandate M53: **Program → Agent → Phase Binding Compiler**.
...
STOP after M53 at the operator gate. Do not begin M54. A green unit test is not sufficient; distinguish authored, code-existing, test-verified, runtime-verified and operator-accepted claims.
