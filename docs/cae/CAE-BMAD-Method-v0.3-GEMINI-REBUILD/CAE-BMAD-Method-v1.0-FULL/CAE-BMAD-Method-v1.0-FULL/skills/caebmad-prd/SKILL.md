---
name: caebmad-prd
description: Create, update, or validate a CCP-style modular CAE PRD with explicit module dependencies, source documents, referenced repository files, functional requirement namespaces, brownfield impact, and acceptance.
---
