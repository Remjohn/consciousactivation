...
description: Transform approved PRD modules and architecture into value-based Epics and implementation-ready Stories with source, FR, architecture, repository, recovery, and proof traceability.
---
