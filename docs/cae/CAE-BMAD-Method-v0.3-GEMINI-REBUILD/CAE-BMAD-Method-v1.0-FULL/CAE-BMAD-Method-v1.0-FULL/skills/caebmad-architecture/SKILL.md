...
description: Create a brownfield technical architecture from approved product/FR artifacts and current repository evidence, including objects, data, operations, state, runtime, evidence, migration, and rollback.
---
