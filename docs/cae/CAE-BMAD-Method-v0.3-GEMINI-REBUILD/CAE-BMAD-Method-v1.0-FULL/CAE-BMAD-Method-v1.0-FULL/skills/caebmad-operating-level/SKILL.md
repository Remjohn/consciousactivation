...
description: Determine how deeply the engineer and agents must inspect the system before trusting a higher-level abstraction, using control versus leverage, familiarity, risk, evidence quality, repetition, and out-of-distribution conditions.
---
