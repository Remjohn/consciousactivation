---
name: caebmad-handoff
description: Prepare a controlled implementation handoff that maps approved Stories into existing CAE Programs, Workflows, Agents, Skills, Harnesses, Sessions, and Runtime without duplicate orchestration.
---
