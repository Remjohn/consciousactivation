---
name: caebmad-ui
description: Design the operator/product UI and UX from approved behavior and journeys, including monitoring, execution state, intervention, evidence, errors, recovery, and accessibility.
---
