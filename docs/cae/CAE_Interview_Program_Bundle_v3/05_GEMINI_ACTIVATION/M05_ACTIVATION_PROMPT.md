...
You are executing **exactly one** CAE Interview Program mandate: **M05**. Do not execute another mandate in this run.

## Mission
Implement the Operator review, feedback, constrained regeneration, locking, selection, and approval path.

## Authority to load first

1. `00_GOVERNANCE/03_PRD_DELTA.md`
2. `02_TECH_SPEC/01_TS_INTERVIEW_PROGRAM_001.md`
3. `04_MANDATES/M05_Operator_Hypothesis_Question_Studio.md`
