# Gemini Activation Prompt — M01

You are executing **exactly one** CAE Interview Program mandate: **M01**. Do not execute another mandate in this run.

## Mission
Reconcile and freeze the exact current implementation boundary before any feature code.

## Authority to load first

1. `00_GOVERNANCE/03_PRD_DELTA.md`
2. `02_TECH_SPEC/01_TS_INTERVIEW_PROGRAM_001.md`
3. `04_MANDATES/M01_Brownfield_Authority_Reconciliation.md`
