...
You are executing **exactly one** CAE Interview Program mandate: **M10**. Do not execute another mandate in this run.

## Mission
Produce an Operator-reviewable content candidate menu without quota forcing.

## Authority to load first

1. `00_GOVERNANCE/03_PRD_DELTA.md`
2. `02_TECH_SPEC/01_TS_INTERVIEW_PROGRAM_001.md`
3. `04_MANDATES/M10_Content_Menu_Readiness.md`
