...
You are executing **exactly one** CAE Interview Program mandate: **M03**. Do not execute another mandate in this run.

## Mission
Implement question objective/mechanism/IR resolution from the approved synthesis without canonizing provisional primitives.

## Authority to load first

1. `00_GOVERNANCE/03_PRD_DELTA.md`
2. `02_TECH_SPEC/01_TS_INTERVIEW_PROGRAM_001.md`
3. `04_MANDATES/M03_Question_Intelligence_Resolution.md`
