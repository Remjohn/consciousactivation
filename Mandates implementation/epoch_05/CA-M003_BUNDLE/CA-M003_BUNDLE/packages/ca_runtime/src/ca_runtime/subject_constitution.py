...
class SubjectConstitution:
    ...
    def unsigned_payload(self) -> dict[str, Any]:
        return {
            ...
            "amendment_receipt_id": self.amendment_receipt_id,
        }
    ...
    def create_signed_baseline(
        ...
        *,
        ...
        with self._lock:
            ...
            signature = _sign(constitution.unsigned_payload(), self._signing_secret)
            constitution = SubjectConstitution(**{**constitution.__dict__, "signature_sha256": signature}) if hasattr(constitution, "__dict__") else SubjectConstitution(
                subject_id=constitution.subject_id,
                revision=constitution.revision,
                status=constitution.status,
                source_evidence_refs=constitution.source_evidence_refs,
                voice_characteristics=constitution.voice_characteristics,
                boundaries=constitution.boundaries,
                validation_state=constitution.validation_state,
                signed_by_operator_id=constitution.signed_by_operator_id,
                signed_at_utc=constitution.signed_at_utc,
                content_sha256=constitution.content_sha256,
                signature_sha256=signature,
                parent_revision=constitution.parent_revision,
                amendment_receipt_id=constitution.amendment_receipt_id,
            )
    ...
    def approve_amendment(
        ...
        *,
        ...
        with self._lock:
            ...
            next_signature = _sign(next_constitution.unsigned_payload(), secret)
            next_constitution = SubjectConstitution(
                ...
                signature_sha256=next_signature,
                parent_revision=next_constitution.parent_revision,
                amendment_receipt_id=None,
            )
