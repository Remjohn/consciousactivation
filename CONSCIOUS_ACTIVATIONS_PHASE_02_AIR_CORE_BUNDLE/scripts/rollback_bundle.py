...
def main():
    p=argparse.ArgumentParser(); p.add_argument("--repo",type=Path,required=True); p.add_argument("--bundle-id",default="CA-PHASE02-AIR-CORE-2026-07-23"); p.add_argument("--force",action="store_true"); a=p.parse_args()
