...
PACKAGES=[ROOT/'packages/ca_contracts',ROOT/'packages/ca_runtime',ROOT/'packages/ca_delegation_rc4',ROOT/'services/air',ROOT/'services/pipeline',ROOT/'services/interview',ROOT/'services/vae',ROOT/'packages/ca_release']
