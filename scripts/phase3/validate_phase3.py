...
def main() -> int:
    ...
    with tempfile.TemporaryDirectory(prefix="ca-phase3-") as temp_dir:
        ...
        checks.append(run([sys.executable, "-m", "compileall", "-q", "services/pipeline/src"], env=env))
        ...
        source_specs = (
            ...
            (ROOT / "services/air", build_sources / "air"),
            (ROOT / "services/pipeline", build_sources / "ahp"),
        )
