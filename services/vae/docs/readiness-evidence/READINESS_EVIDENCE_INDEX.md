...
| Recovery and rollback | Ten-event deterministic contract simulation | Simulation `PASS`; executable runtime proof `FAIL` |
| Format 02 integration | RC4 demand boundary, portable derivative-lock mapping, provider-neutral plan, two controlled SVG candidates, targeted repair and result/usage fixtures | RC4 contract/fixture chain `PASS`; real end-to-end proof `FAIL` |
| Sources | Availability declaration | `SRC-001` and `SRC-009` remain unavailable evidence |

Detailed reports:

- `EVALUATOR_CALIBRATION_REPORT.md`
- `LOCAL_GPU_PROOF.md`
- `CLOUD_GPU_PROOF.md`
- `RECOVERY_ROLLBACK_PROOF.md`
- `FORMAT02_END_TO_END_PROOF.md`
- `READINESS_EVIDENCE_VERDICT.md`

All reusable scripts in this package are labeled `non_production_readiness_proof` and require a later authorized implementation Story before production incorporation.
