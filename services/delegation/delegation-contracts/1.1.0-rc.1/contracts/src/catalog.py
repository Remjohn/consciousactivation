            ...
            "activative_semantic_lineage": obj(
                {
                    ...
                    "activative_call_refs": array(ref("ResourceIdentityRef")),
                    "reaction_receipt_refs": array(ref("ResourceIdentityRef")),
                    "expression_moment_refs": array(ref("ResourceIdentityRef")),
                ...
                obj(
                    {
                        ...
                        "effect": string(enum=["PRESERVED", "SPLIT_WITH_EVIDENCE"]),
                    }
                ),
                minItems=1,
            ),
