...
class ContractSchemaTests(unittest.TestCase):
    def test_all_registered_examples_validate(self) -> None:
        self.assertEqual(validate_all_examples(), 27)
    ...
    def test_registry_has_unique_pinned_schema_ids(self) -> None:
        ...
        self.assertEqual(registry["package_version"], "1.1.0-rc.4")
        package_json = json.loads((ROOT / "contracts/package.json").read_text(encoding="utf-8"))
        self.assertEqual(package_json["version"], "1.1.0-rc.4")
        self.assertIn(
            'version = "1.1.0rc4"',
            (ROOT / "contracts/pyproject.toml").read_text(encoding="utf-8"),
        )
        self.assertIn(
            'version = "1.1.0rc4"',
            (ROOT / "validators/pyproject.toml").read_text(encoding="utf-8"),
        )
