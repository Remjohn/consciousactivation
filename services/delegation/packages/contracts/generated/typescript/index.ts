...
export const PACKAGE_VERSION = "1.1.0-rc.4" as const;
export const PROTOCOL_VERSION = "1.0" as const;
export const VISUAL_ASSET_DEMAND_VERSION = "1.1" as const;
export const COMPATIBILITY_PROFILE_VERSION = "1.0" as const;
...
export type DerivationType = "DETERMINISTIC_CROP" | "DETERMINISTIC_RESIZE" | "DETERMINISTIC_FORMAT_CONVERSION" | "DETERMINISTIC_COMPOSITE" | "SEMANTIC_TRANSFORMATION" | "TRANSFORMATIVE_RECOMPOSITION";
export type DerivativeSemantics = "NON_SEMANTIC" | "SEMANTIC_TRANSFORMATIVE";
...
export interface DerivativeLockInheritance {
  inheritance_id: string;
  authoritative_parent_ref: Record<string, unknown>;
  parent_contract_version: string;
  governing_authoritative_demand_ref: Record<string, unknown>;
  parent_lock_evidence: ParentLockEvidence;
  derivative_ref: Record<string, unknown>;
  derivative_wrong_reading_locks: Array<WrongReadingLockEvidence>;
  derivation_type: DerivationType;
  derivative_semantics: DerivativeSemantics;
  authoritative_lock_authorization: AuthoritativeLockAuthorization | null;
  declared_at: string;
}
...
export interface CompatibilityManifest {
  ...
  required_semantic_domains: Array<"source_provenance" | "activative_semantic_lineage" | "activation_contract" | "visual_semantic_pack" | "visual_narrative_program" | "feature_contracts" | "somatic_route_request" | "expression_moment_lineage" | "wrong_reading_locks" | "derivative_lock_inheritance">;
  semantic_capabilities: Array<Record<string, unknown>>;
  adapter_policy: Record<string, unknown>;
  derivative_asset_flows: Record<string, unknown>;
