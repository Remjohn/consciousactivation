...
Constitutional V1.1 sharpens this rule: a receiver must preserve and enforce
Activative lineage, Activation Contract, Visual Semantic/Narrative programs,
Feature Contracts, T/V routing, Expression Moment lineage, and wrong-reading
locks. Parsing those fields without evaluator-backed behavior is incompatible;
the protocol validates this evidence without acquiring creative authority.
