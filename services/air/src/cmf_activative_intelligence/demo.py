...
def run_demo(database_path: str | Path) -> dict[str, Any]:
    ...
    return {
        ...
        "edge_product": dict(coalition_payload["edge_product"]),
        "edge_product_ref": {"object_id": coalition_payload["edge_product"]["edge_product_id"], "version": "1.0.0", "sha256": canonical_sha256(coalition_payload["edge_product"])},
