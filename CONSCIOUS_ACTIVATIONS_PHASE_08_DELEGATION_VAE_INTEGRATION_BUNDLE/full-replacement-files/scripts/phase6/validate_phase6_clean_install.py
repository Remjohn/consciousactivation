...
def main():
 ...
 with tempfile.TemporaryDirectory(prefix='ca-phase6-install-') as td:
  t=Path(td);install=t/'install';build=t/'build';sources=[(ROOT/'packages/ca_contracts',build/'contracts'),(ROOT/'packages/ca_runtime',build/'runtime'),(ROOT/'packages/ca_delegation_rc4',build/'delegation'),(ROOT/'04_ACTIVATIVE_INTELLIGENCE_RUNTIME',build/'air'),(ROOT/'05_ATOMIC_HARNESS_PIPELINE',build/'pipeline'),(ROOT/'06_INTERVIEW_EXPRESSION',build/'interview')]
