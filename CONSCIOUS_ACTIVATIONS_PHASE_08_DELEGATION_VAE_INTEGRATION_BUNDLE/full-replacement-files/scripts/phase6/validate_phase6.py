...
SRC=[ROOT/'packages/ca_contracts/src',ROOT/'packages/ca_runtime/src',ROOT/'packages/ca_delegation_rc4/src',ROOT/'04_ACTIVATIVE_INTELLIGENCE_RUNTIME/src',ROOT/'05_ATOMIC_HARNESS_PIPELINE/src',ROOT/'06_INTERVIEW_EXPRESSION/src']
def run(command,env):
...
def main():
 ...
 with tempfile.TemporaryDirectory(prefix='ca-phase6-') as td:
  ...
  checks.append(run([sys.executable,'-m','compileall','-q','04_ACTIVATIVE_INTELLIGENCE_RUNTIME/src','05_ATOMIC_HARNESS_PIPELINE/src','06_INTERVIEW_EXPRESSION/src','packages/ca_contracts/src','packages/ca_runtime/src','packages/ca_delegation_rc4/src'],env))
