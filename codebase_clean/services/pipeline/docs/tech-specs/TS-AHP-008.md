...
output_path: 05_ATOMIC_HARNESS_PIPELINE/docs/tech-specs/TS-AHP-008.md
controlling_frs: ['FR-043', 'FR-044', 'FR-045', 'FR-046', 'FR-047', 'FR-048']
controlling_stories: ['ST-07.04']
upstream_draft_dependencies: ['TS-PM-001', 'TS-AIR-003', 'TS-EVAL-001']
---
...
|---|---|---|---|---|---|
| `SDE-116` | `TS-PM-001` | `05_ATOMIC_HARNESS_PIPELINE/docs/tech-specs/TS-PM-001.md` | `WRITTEN_PENDING_AUDIT` | `64506bfbfb1827d630e11ea5f4fc8bd0e3bd5c0d22b41570ce8bcb5b5069cc30` | `DRAFT_DEPENDENCY_NOT_ACCEPTED` |
| `SDE-117` | `TS-AIR-003` | `04_ACTIVATIVE_INTELLIGENCE_RUNTIME/docs/tech-specs/TS-AIR-003.md` | `WRITTEN_PENDING_AUDIT` | `ce9ac739346789d115ada80c44b568c28e61ce68f0ae99bb55b0962c875d430c` | `DRAFT_DEPENDENCY_NOT_ACCEPTED` |
| `SDE-118` | `TS-EVAL-001` | `05_ATOMIC_HARNESS_PIPELINE/docs/tech-specs/TS-EVAL-001.md` | `WRITTEN_PENDING_AUDIT` | `0c3a47dc3cfb331630df794bec4869c71d5fc70894b6f0fd77b08068ff74024f` | `DRAFT_DEPENDENCY_NOT_ACCEPTED` |
...
The problem is that `Adaptive Candidate Search, Comparison, Budget, and Stopping` must be implemented later without collapsing semantic authority, source provenance, category/profile support, evaluation evidence or lifecycle state into informal notes. The user outcome is a replayable and reviewable product boundary where every command, output, denial and repair points back to exact source, owner, version and receipt evidence.
...
|---|---|---|---|
| `FR-043` | `Atomic Harness Pipeline` | `TS-AHP-008` | `SPECIFICATION_ONLY_NO_IMPLEMENTATION_NO_PRODUCTION_NO_CERTIFICATION` |
| `FR-044` | `Atomic Harness Pipeline` | `TS-AHP-008` | `SPECIFICATION_ONLY_NO_IMPLEMENTATION_NO_PRODUCTION_NO_CERTIFICATION` |
| `FR-045` | `Atomic Harness Pipeline` | `TS-AHP-008` | `SPECIFICATION_ONLY_NO_IMPLEMENTATION_NO_PRODUCTION_NO_CERTIFICATION` |
| `FR-046` | `Atomic Harness Pipeline` | `TS-AHP-008` | `SPECIFICATION_ONLY_NO_IMPLEMENTATION_NO_PRODUCTION_NO_CERTIFICATION` |
| `FR-047` | `Atomic Harness Pipeline` | `TS-AHP-008` | `SPECIFICATION_ONLY_NO_IMPLEMENTATION_NO_PRODUCTION_NO_CERTIFICATION` |
| `FR-048` | `Atomic Harness Pipeline` | `TS-AHP-008` | `SPECIFICATION_ONLY_NO_IMPLEMENTATION_NO_PRODUCTION_NO_CERTIFICATION` |

| Story | Spec binding | Current quality state |
|---|---|---|
| `ST-07.04` | `TS-AHP-008` | `WRITTEN_PENDING_AUDIT` |
...
The central implementation object is `TS_AHP_008_RuntimeContract`. It consumes TS-PM-001, TS-AIR-003, TS-EVAL-001, the Prompt 02C packet, the authority-stage decision and the writing-wave lock. It emits one of three outcomes: a valid artifact package, a typed denial, or a scoped repair/escalation request.
...
|---|---|---|
| `TS_AHP_008_Command` | `command_id`, `idempotency_key`, `caller`, `target_version`, `source_refs`, `authority_refs`, `operation` | Reject before side effects when authority or version is stale. |
| `TS_AHP_008_State` | `state_id`, `version`, `lifecycle_state`, `pinned_dependencies`, `not_applicable_fields`, `lineage` | Immutable per version and deterministically serialized. |
| `TS_AHP_008_Receipt` | `receipt_id`, `command_id`, `result`, `artifact_refs`, `hashes`, `failure_context` | Receipt storage without artifact or denial context is invalid. |
| `TS_AHP_008_Invalidation` | `reason`, `owner`, `affected_descendants`, `replacement_refs`, `historical_replay_policy` | Descendant-only unless upstream authority issues a new demand/version. |
