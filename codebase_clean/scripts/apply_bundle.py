...
KNOWN_BUNDLES: list[Path] = [
    ...
    REPO_ROOT / "CONSCIOUS_ACTIVATIONS_PHASE_05_SEMANTIC_PRODUCTION_COMPILER_BUNDLE"
    / "CONSCIOUS_ACTIVATIONS_PHASE_05_SEMANTIC_PRODUCTION_COMPILER_BUNDLE",
    REPO_ROOT / "CONSCIOUS_ACTIVATIONS_PHASE_06_COMPOSITION_MEDIA_RUNTIMES_BUNDLE"
    / "CONSCIOUS_ACTIVATIONS_PHASE_06_COMPOSITION_MEDIA_RUNTIMES_BUNDLE",
    REPO_ROOT / "CONSCIOUS_ACTIVATIONS_PHASE_07_STUDIO_SUPERVISION_BUNDLE"
    / "CONSCIOUS_ACTIVATIONS_PHASE_07_STUDIO_SUPERVISION_BUNDLE",
]
...
def main() -> int:
    ...
    if not (repo / "governance/program-control").is_dir():
        print(
            json.dumps(
