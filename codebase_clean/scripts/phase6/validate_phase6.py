...
SRC=[ROOT/'packages/ca_contracts/src',ROOT/'packages/ca_runtime/src',ROOT/'packages/ca_delegation_rc4/src',ROOT/'services/air/src',ROOT/'services/pipeline/src',ROOT/'services/interview/src']
def run(command,env):
...
def main():
 ...
 with tempfile.TemporaryDirectory(prefix='ca-phase6-') as td:
  ...
  checks.append(run([sys.executable,'-m','compileall','-q','services/air/src','services/pipeline/src','services/interview/src','packages/ca_contracts/src','packages/ca_runtime/src','packages/ca_delegation_rc4/src'],env))
  paths=['tests/phase6','tests/phase5','tests/phase4','services/interview/tests','tests/phase3','tests/phase2','tests/phase1','tests/traceability']
