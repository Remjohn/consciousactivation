"""Apply the guarded WP-07 execution-receipt/evidence-lineage migration."""
...
MIGRATION_PATH = Path("docs/cae/implementation/sql/0008_cae_execution_receipt_lineage.sql")
MIGRATION_ACTOR = "cae-wp07-receipt-lineage-runner"
    ...
    try:
        with psycopg.connect(connection_url(), connect_timeout=10) as connection:
            with connection.cursor() as cursor:
                ...
                cursor.execute("SELECT count(*) FROM cae.receipt")
            ...
            if arguments.check:
                ...
                print(f"existing_receipt_count={receipt_count}")
            ...
            if receipt_count:
                print("migration_status=REFUSED_EXISTING_RECEIPTS_REQUIRE_BACKFILL_DECISION")
                return 2
