"""Apply the guarded WP-03 first-slice semantic-operation registry migration."""
...
MIGRATION_VERSION = "0004_cae_first_slice_semantic_operations"
MIGRATION_PATH = Path("docs/cae/implementation/sql/0004_cae_first_slice_semantic_operations.sql")
MIGRATION_ACTOR = "cae-wp03-operation-registration-runner"
