...
REPORT=ROOT/'governance/program-control/03_PROGRAM_STATUS/PHASE_06_COMPOSITION_MEDIA_RUNTIME'
...
def test_phase6_traceability_complete():
    ...
    for row in specs:
        assert (ROOT/'services/pipeline/docs/tech-specs'/f"{row['spec_id']}.md").is_file()
