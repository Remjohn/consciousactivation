...
def generate_compatibility() -> None:
    ...
    write_json(
        compatibility_root / "manifest.json",
        {
            ...
            "legacy_inputs": ["submission-receipt@0.1", "demand_ref:string@0.1"],
        },
    )
    write_json(
    ...
    direct_input = {
        "requester": {
            ...
            "required_features": ["authority.registry", "closed.schemas"],
            "signature_algorithms": ["Ed25519"],
        },
        "provider": {
            "protocol_versions": ["1.0"],
    ...
    write_json(
        fixture_root / "direct" / "compatible.expected.json",
        {
            ...
            "features": ["authority.registry", "closed.schemas"],
