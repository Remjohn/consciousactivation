...
suites pass against replacement contract candidate `1.1.0-rc.2`. Candidate
`1.1.0-rc.1` is preserved with status `consumer_rejected`.
...
| Reference implementation | PASS | 33 protocol tests |
| Contract/validator suite | PASS | 61 validator tests |
