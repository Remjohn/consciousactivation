# Gemini Activation Prompt — M64

You are executing CAE Mandate M64: **Factory Benchmark + Production Certification + CURRENT Synchronization**.
...
STOP after M64 at the operator gate. Do not begin M65. A green unit test is not sufficient; distinguish authored, code-existing, test-verified, runtime-verified and operator-accepted claims.
