# M14 — Program Registry + Package Discovery

    Status: PROPOSED — OPERATOR-RATIFICATION-REQUIRED
    Phase: 2 — Runtime Foundation

    ## 1. Decision / Objective
    Make operator-addressable Programs discoverable as governed packages, with filesystem composition separated from canonical state/permissions.

    ## 2. Mandatory reading before action
    Baseline: `00_CONTROL/01_BASELINE_AUTHORITY_READ_SET.md`
    Mandate-specific:
    Phase 1 M2/M8; 00_CONTROL/22_PHASE2_AGENT_PACKAGE_COMPILATION_CONTRACT.md; current program-control; current Pi/Eve package docs.
...
- Agent text, UI status or a receipt without matching state/artifact evidence is not completion proof.
    ...
    ## 3. Allowed work
    Implement Program manifest validation/registry projection, version/hash capture, dependency/authority checks, and pre-execution inspection.
    ...
    A valid Program can be listed, inspected, resolved and preflighted; invalid/missing authority or dependencies fail closed.
