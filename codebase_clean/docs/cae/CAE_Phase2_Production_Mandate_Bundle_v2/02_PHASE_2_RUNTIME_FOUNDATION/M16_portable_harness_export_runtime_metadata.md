# M16 — Portable Harness Export Runtime Metadata

    Status: PROPOSED — OPERATOR-RATIFICATION-REQUIRED
    Phase: 2 — Runtime Foundation

    ## 1. Decision / Objective
    Correct Builder export only where verified runtime evidence shows that workflow, actor/role, capability or execution metadata is lost.

    ## 2. Mandatory reading before action
    Baseline: `00_CONTROL/01_BASELINE_AUTHORITY_READ_SET.md`
    Mandate-specific:
    M10; Builder portable export; Pipeline intake/bindings; CURRENT.md named blocker; manifest schemas.
...
- Agent text, UI status or a receipt without matching state/artifact evidence is not completion proof.
    ...
    ## 3. Allowed work
    Add the smallest backward-compatible export/schema/migration corrections necessary for runtime binding.
    ...
    A real authored Harness round-trips all required runtime metadata; compatibility tests pass.
