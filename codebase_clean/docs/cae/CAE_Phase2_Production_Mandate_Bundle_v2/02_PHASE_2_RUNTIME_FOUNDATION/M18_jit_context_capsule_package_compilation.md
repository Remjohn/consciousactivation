# M18 — JIT Context Capsule + Package Compilation

    Status: PROPOSED — OPERATOR-RATIFICATION-REQUIRED
    Phase: 2 — Runtime Foundation

    ## 1. Decision / Objective
    Make JIT runtime context assemble from governed project/Program/Harness/Agent context, Skills, capabilities and artifacts with version/hash/budget evidence.

    ## 2. Mandatory reading before action
    Baseline: `00_CONTROL/01_BASELINE_AUTHORITY_READ_SET.md`
    Mandate-specific:
    Skill Constitution; Builder JIT capsule; Phase 1 M5/M6; 00_CONTROL/22_PHASE2_AGENT_PACKAGE_COMPILATION_CONTRACT.md; 27_PHASE2_CONTEXT_BUDGET_CONTRACT.md; Eve context-control docs.
...
- Agent text, UI status or a receipt without matching state/artifact evidence is not completion proof.
    ...
    ## 3. Allowed work
    Implement package/context compilation, Skill maturity gates, capability resolution, local CAE.md/AGENTS.md precedence, and observable context inclusion/exclusion.
    ...
    The pilot Agent receives a reproducible declared context capsule; forbidden/missing context blocks; loaded context is observable.
