...
You are executing **exactly one** CAE Interview Program mandate: **M04**. Do not execute another mandate in this run.

## Mission
Compile selected material into the existing Activative Interview Brief contract.

## Authority to load first

1. `00_GOVERNANCE/03_PRD_DELTA.md`
2. `02_TECH_SPEC/01_TS_INTERVIEW_PROGRAM_001.md`
3. `04_MANDATES/M04_Interview_Brief_Compilation.md`
