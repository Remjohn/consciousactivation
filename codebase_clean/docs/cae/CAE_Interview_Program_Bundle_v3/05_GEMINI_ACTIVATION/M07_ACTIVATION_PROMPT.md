...
You are executing **exactly one** CAE Interview Program mandate: **M07**. Do not execute another mandate in this run.

## Mission
Implement the minimum answer observation/state model and evidence/inference distinction.

## Authority to load first

1. `00_GOVERNANCE/03_PRD_DELTA.md`
2. `02_TECH_SPEC/01_TS_INTERVIEW_PROGRAM_001.md`
3. `04_MANDATES/M07_Semantic_Acquisition_Observation.md`
