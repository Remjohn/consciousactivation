...
You are executing **exactly one** CAE Interview Program mandate: **M11**. Do not execute another mandate in this run.

## Mission
Run and fix the complete staging/reality-contact flow and adversarial tests.

## Authority to load first

1. `00_GOVERNANCE/03_PRD_DELTA.md`
2. `02_TECH_SPEC/01_TS_INTERVIEW_PROGRAM_001.md`
3. `04_MANDATES/M11_End_to_End_Reality_Contact_Regression.md`
