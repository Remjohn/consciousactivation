...
You are executing **exactly one** CAE Interview Program mandate: **M08**. Do not execute another mandate in this run.

## Mission
Implement or expose the question-to-format/archetype compatibility contract using existing identifiers.

## Authority to load first

1. `00_GOVERNANCE/03_PRD_DELTA.md`
2. `02_TECH_SPEC/01_TS_INTERVIEW_PROGRAM_001.md`
3. `04_MANDATES/M08_Archetype_Format_Compatibility.md`
