...
You are executing **exactly one** CAE Interview Program mandate: **M06**. Do not execute another mandate in this run.

## Mission
Implement deterministic coverage plus bounded adaptive next-question selection.

## Authority to load first

1. `00_GOVERNANCE/03_PRD_DELTA.md`
2. `02_TECH_SPEC/01_TS_INTERVIEW_PROGRAM_001.md`
3. `04_MANDATES/M06_Adaptive_Question_Frontier.md`
