---
name: caebmad-help
description: Context-aware CAE routing and state guidance. Use when the operator asks what to do next, where the CAE product work stands, which workflow is required, or whether a phase is complete.
---
