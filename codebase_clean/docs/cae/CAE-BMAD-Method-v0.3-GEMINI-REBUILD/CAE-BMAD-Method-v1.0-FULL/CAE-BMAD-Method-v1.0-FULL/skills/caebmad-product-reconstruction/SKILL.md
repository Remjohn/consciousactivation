...
description: Reconstruct the CAE product from historical lineage, the 216-source research corpus, existing product documentation, actual repository structure, production systems such as Atomic Harnesses and Visual Syntax, and current runtime evidence before rewriting the product definition.
---
