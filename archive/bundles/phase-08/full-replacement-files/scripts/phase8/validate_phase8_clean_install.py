...
SOURCE_PACKAGES = [
    ...
    (ROOT / "04_ACTIVATIVE_INTELLIGENCE_RUNTIME", "air"),
    (ROOT / "05_ATOMIC_HARNESS_PIPELINE", "pipeline"),
    (ROOT / "06_INTERVIEW_EXPRESSION", "interview"),
    (ROOT / "02_VISUAL_ASSET_EDITOR", "vae"),
]
