...
- New dependency: DEP-VIS-010 (Source Win-Rate Matrix)
- New dependency: DEP-VIS-011 (T-Score Configuration)
...
**Reads From:** DEP-VIS-005 (VCB), DEP-VIS-006 (Known Persons Registry), DEP-VIS-010 (Source Win-Rate Matrix), DEP-VIS-011 (T-Score Configuration)
  ...
  "gen_searcher_fallback": {
    ...
    "tools": [
      ...
      },
      {
        ...
        "endpoint": "http://ccp-searxng:8080/search?q={query}&format=json&categories=documentary_photo,editorial_news"
      },
      {
        "name": "browse",
...
**DEP-VIS-011 — T-Score Configuration:**

```json
{
  "dependency_id": "DEP-VIS-011",
...
sieve_checks:
  - name: "resolution_check"
    rule: "image width >= 1080px AND height >= 1080px"
...
deep_ranker:
  ...
  per_candidate_evaluation:
    ...
    output_processing: "compute weighted T-Score from 5 dimension scores"
  ...
  ranking_logic:
    ...
    - "Log to DEP-VIS-010 Source Win-Rate Matrix"
```
...
## Section 7 — Source Win-Rate Matrix (DEP-VIS-010)

### 7.1 Dependency Specification

```json
{
  "dependency_id": "DEP-VIS-010",
...
- Encode T-Score evaluation prompts in DEP-VIS-011
- Initialize DEP-VIS-010 Source Win-Rate Matrix with uniform weights
...
|:---|:---|:---|
| DEP-VIS-010 | Source Win-Rate Matrix | NEW — initialized with uniform weights |
| DEP-VIS-011 | T-Score Configuration | NEW — five-dimension tribal reward function |
