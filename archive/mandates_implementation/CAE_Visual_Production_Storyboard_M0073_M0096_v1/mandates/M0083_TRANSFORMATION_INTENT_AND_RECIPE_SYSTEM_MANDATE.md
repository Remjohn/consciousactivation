...
The authorized decision is: **Implement TransformationIntent and TransformationRecipe as the projection layer between grammar/calculus and primitive operations/keyframes. Establish a compact taxonomy of meaningful transformation intents and governed recipes.**
...
Implement compact TransformationIntent and TransformationRecipe schemas and compilation. Intent must capture why the source changes; recipe maps intent to approved primitives and motion/keyframe templates. Support source, semantic target, mode, emphasis, motion and constraints. Avoid a giant free-form effects catalog.
