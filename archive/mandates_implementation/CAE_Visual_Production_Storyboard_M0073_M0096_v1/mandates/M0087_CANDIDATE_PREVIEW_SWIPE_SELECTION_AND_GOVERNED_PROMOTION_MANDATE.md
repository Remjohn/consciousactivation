# M0087 — Candidate Preview, Swipe Selection and Governed Promotion
...
The authorized decision is: **Build the candidate-preview interaction: playable previews, swipe/next/previous inspection, accept/reject, automatic acceptance where gates permit, promotion into Storyboard/VAE, rejection lineage and source provenance receipts.**
...
Implement fast candidate preview and selection. Candidate cards must show actual playable media when available, source/interval/rights metadata, and ranking/eligibility information. Support swipe/next/previous, accept, reject, search again and deterministic automatic acceptance. Record each decision and preserve rejected alternatives.
