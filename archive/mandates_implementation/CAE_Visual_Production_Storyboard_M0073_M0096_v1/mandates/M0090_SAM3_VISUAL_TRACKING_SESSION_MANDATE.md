# M0090 — SAM3 Visual Tracking Session
...
**Campaign batch:** C2 VISUAL INTELLIGENCE
...
The authorized decision is: **Integrate SAM3 as a first-class Visual Intelligence capability with operator-controlled TrackingSession, target selection, face/box/point/mask seeding, track revisions and governed geometry output usable by Storyboard, SuperVisual and OpenChatCut.**
...
Implement operator-controlled SAM3 TrackingSession, TrackingTarget, TrackingPrompt, TrackSegment and TrackRevision. Operator selects the desired speaker/subject and seeds SAM3 using face/box/point/mask. Output must include source frame/hash, confidence, gaps/revisions and governed geometry usable by Storyboard/BBOX/OpenChatCut. Visual tracking is not semantic identity authority.
...
**Allowed boundary:** `engines/intelligence/vision/sam3/ or approved runtime boundary, services/, packages/, apps/web/, tests`
