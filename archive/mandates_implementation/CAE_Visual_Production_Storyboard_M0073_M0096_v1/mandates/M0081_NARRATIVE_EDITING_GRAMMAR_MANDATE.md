...
The authorized decision is: **Create the CAE-native Narrative Editing Grammar: a constrained executable vocabulary describing how narrative and activative meaning becomes perceptual expression. Bind it to scenes, archetypes and harnesses without making the grammar an effects catalog.**
...
Implement a registry and validator for Narrative Editing Grammar: WITHHOLD, REVEAL, FOCUS, CONTRAST, PROVE, EXPLAIN, CONNECT, ESCALATE, INTERRUPT and RESOLVE at minimum. Grammar entries define relational/sequence patterns and allowed scene contexts, not effect recipes. Include archetype and activative meaning inputs and false-proof tests.
...
**Allowed boundary:** `packages/, docs/cae/specs/, tests`
