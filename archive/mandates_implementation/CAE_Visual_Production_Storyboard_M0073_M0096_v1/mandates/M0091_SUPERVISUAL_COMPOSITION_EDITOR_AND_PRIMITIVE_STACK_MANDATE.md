...
The authorized decision is: **Expose BBOX, Pretext, Skia and Rough Notation through a coherent SuperVisual composition/editor surface, preserving their distinct primitive roles while enabling evidence-based source transformation, annotation and deterministic spatial composition.**
...
Build SuperVisual editor over BBOX, Pretext, Skia and Rough Notation. BBOX owns geometry; Pretext owns text fit; Skia owns rendering substrate; Rough Notation owns annotation primitives. The editor must support evidence-grounded source transformations, layer inspection, annotation, deterministic composition and operator revision without conflating primitive roles.
...
**Allowed boundary:** `engines/visual/supervisual/, services/, packages/, apps/web/, tests`
