...
The authorized decision is: **Create the deterministic quantitative layer that maps narrative editing grammar into bounded editorial variables such as pace, duration, occupancy, scale, motion amplitude, density, salience and intervention frequency.**
...
Implement deterministic Editorial Expression Calculus over pace, shot duration, hold duration, cut interval, occupancy, scale, motion amplitude, motion velocity, visual density, caption density, contrast, salience and intervention frequency. Provide bounded profiles by format/scene and tests for determinism and source-quality constraints.
