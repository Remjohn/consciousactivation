# M0084 — Evidence-First Source Quality and Adaptive Transformation Rules
...
The authorized decision is: **Implement SourceQualityProfile and evidence-first transformation constraints so source resolution, crop history, compression, sharpness, frame rate and prior degradation influence permissible transformations and presentation strategies.**
...
Implement SourceQualityProfile and adaptive transformation validation. High-quality 4K/1080p may permit subtle zoom/reframe/color changes when perceptually safe; low/degraded sources may require containerization, reduced scaling, grayscale or contextualization. Every adaptation must remain evidence-preserving and testable.
