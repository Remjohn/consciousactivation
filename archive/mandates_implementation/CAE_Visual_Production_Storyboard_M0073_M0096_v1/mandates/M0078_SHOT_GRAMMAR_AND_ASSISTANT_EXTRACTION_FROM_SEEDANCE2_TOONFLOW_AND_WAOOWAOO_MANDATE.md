# M0078 — Shot Grammar and Assistant Extraction from Seedance2 Toonflow and WaooWaoo
...
The authorized decision is: **Synthesize bounded shot schema, camera/timing vocabulary, structured scene/shot fields, and assistant/refinement interaction from Seedance2, Toonflow and WaooWaoo into CAE reference material. Do not create a new semantic authority or copy provider-specific generation logic.**
...
Create one CAE reference vocabulary from Seedance2, Toonflow and WaooWaoo. Seedance2 contributes shot/camera/timing/continuity language; Toonflow contributes explicit scene/shot/asset fields; WaooWaoo contributes assistant/canvas refinement and version interaction. Every field or behavior must retain source attribution and no external semantic authority may be created.
...
**Allowed boundary:** `campaign reference schema, docs, registry and tests`
...
No new semantic program authority and no prompt-as-authority model.
