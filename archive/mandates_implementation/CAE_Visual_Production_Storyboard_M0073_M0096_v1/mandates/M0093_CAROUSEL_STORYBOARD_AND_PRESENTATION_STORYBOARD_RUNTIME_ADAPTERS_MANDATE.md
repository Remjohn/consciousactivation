# M0093 — Carousel Storyboard and Presentation Storyboard Runtime Adapters
...
The authorized decision is: **Build the format adapters for carousel and presentation storyboard programs, with Slidev/reveal and optional Open Carrusel preview/editor integration. Preserve shared storyboard contracts and keep format-specific runtimes downstream.**
...
Implement CarouselStoryboardProgram and PresentationStoryboardProgram adapters. Slidev and reveal.js are downstream presentation runtimes. Open Carrusel is optional operator preview/editor integration, not semantic authority. The implementation must preserve shared storyboard objects and format-specific constraints and prove compilation/preview behavior.
...
**Allowed boundary:** `engines/presentation/, engines/carousel/, adapters, apps/web/, tests`
