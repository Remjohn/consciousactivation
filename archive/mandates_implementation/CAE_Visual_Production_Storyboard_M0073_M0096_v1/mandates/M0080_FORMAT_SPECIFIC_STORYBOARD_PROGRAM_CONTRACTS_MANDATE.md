# M0080 — Format-Specific Storyboard Program Contracts
...
The authorized decision is: **Create VideoStoryboardProgram, CarouselStoryboardProgram, SuperVisualStoryboardProgram and PresentationStoryboardProgram contracts that share canonical storyboard objects while defining format-specific composition grammar and constraints.**
...
Implement VideoStoryboardProgram, CarouselStoryboardProgram, SuperVisualStoryboardProgram and PresentationStoryboardProgram using shared storyboard objects. Video must support temporal structure; Carousel slide progression; SuperVisual spatial composition; Presentation slide/build semantics. Each program must compile to bounded expression objects without redefining semantic meaning.
...
**Allowed boundary:** `programs/, packages/, docs/cae/specs/, tests`
