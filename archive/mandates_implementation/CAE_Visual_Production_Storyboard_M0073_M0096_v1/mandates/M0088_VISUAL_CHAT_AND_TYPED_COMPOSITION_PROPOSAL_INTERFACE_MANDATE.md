# M0088 — Visual Chat and Typed Composition Proposal Interface
...
The authorized decision is: **Build Visual Chat as a governed operator interaction surface for explaining visual intent, generating alternatives, regenerating transformation proposals, modifying BBOX prompts and requesting source swaps without allowing chat to bypass validation or authority gates.**
...
Implement Visual Chat against typed Storyboard/VAE proposals. Support explain, alternative candidates, source replacement, transformation regeneration, BBOX prompt regeneration, intensity adjustment and composition suggestions. Chat may not directly bypass validators or promotion gates. Every applied change must retain revision lineage.
...
**Allowed boundary:** `apps/web/, api/, services/, packages/, tests`
