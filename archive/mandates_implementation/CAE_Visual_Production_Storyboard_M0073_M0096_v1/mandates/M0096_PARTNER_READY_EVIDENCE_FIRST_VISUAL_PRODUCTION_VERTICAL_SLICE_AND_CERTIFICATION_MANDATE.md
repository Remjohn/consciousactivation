# M0096 — Partner-Ready Evidence-First Visual Production Vertical Slice and Certification
...
The authorized decision is: **Execute and certify one partner-ready end-to-end vertical slice covering authenticated source evidence, asset research, transformation, storyboard, operator correction, SAM3 tracking when needed, SuperVisual or OpenChatCut execution, receipts, release readiness and exact commit capture.**
...
Execute the terminal partner-ready vertical slice from real/governed source evidence through Asset Research, Storyboard, Transformation, operator correction, optional SAM3 tracking, SuperVisual or OpenChatCut runtime, receipts and release decision. No synthetic/mock evidence may stand in for live proof. Capture exact commit SHA and explicit readiness status.
...
**Allowed boundary:** `tests/e2e/, docs/cae/evidence/, docs/cae/certification/, release/control manifests`
